...
def build_output_tables(edge_gdf: gpd.GeoDataFrame) -> dict[str, pd.DataFrame]:
    return {
        ...
        "walk_distance_matrix": build_adjacency_matrix(edge_gdf, "walk_distance_m", node_label_mode="label"),
        "walk_time_matrix": build_adjacency_matrix(edge_gdf, "walk_time_min", node_label_mode="label"),
        "drive_distance_matrix": build_adjacency_matrix(edge_gdf, "drive_distance_m", node_label_mode="label"),
        "drive_time_offpeak_matrix": build_adjacency_matrix(edge_gdf, "drive_time_min_offpeak", node_label_mode="label"),
        "drive_time_am_matrix": build_adjacency_matrix(edge_gdf, "drive_time_min_am_peak_7_8", node_label_mode="label"),
        "drive_time_pm_matrix": build_adjacency_matrix(edge_gdf, "drive_time_min_pm_peak_3_4", node_label_mode="label"),
        "all_pairs_walk_time_matrix": build_all_pairs_shortest_path_matrix(edge_gdf, "walk_time_min"),
        "all_pairs_drive_time_am_matrix": build_all_pairs_shortest_path_matrix(edge_gdf, "drive_time_min_am_peak_7_8"),
        "all_pairs_drive_time_pm_matrix": build_all_pairs_shortest_path_matrix(edge_gdf, "drive_time_min_pm_peak_3_4"),
    }
...
def main() -> None:
    ...
    if config.create_school_routes:
        ...
        # Additionally build Top 10 routes map + summary per user request
        try:
            create_top10_routes(
                tracts_gdf=tract_nodes,
                edge_gdf=edge_network,
                id_col=id_col,
                out_map="top10_routes.png",
                out_csv="top10_route_summary.csv",
            )
        except Exception as exc:
